...
import com.tamyres.ControleDeAnime.services.AvaliacaoService;
...
public class AvaliacaoResource {
	...
	public ResponseEntity<Void> insert(@Valid @RequestBody AvaliacaoDTO objDto) {
